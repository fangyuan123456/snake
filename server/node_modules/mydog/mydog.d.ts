...
export interface Application {
     ...
     * 配置： route.ts
     */
    readonly routeConfig: {[key:string]:I_proto};
     ...
     * 向客户端发送消息 （后端服调用）
     */
    sendMsgByUidSid(cmdName: string, msg: any, uidsid: { "uid": number, "sid": string }[]): void;

    /**
     * 向客户端发送消息 （后端服调用）
     */
    sendMsgByGroup(cmdName: string, msg: any, group: { [sid: string]: number[] }): void;
