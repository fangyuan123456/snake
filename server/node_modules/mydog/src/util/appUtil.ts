...
export function f_endsWith(str:string,hz:string){
    if(hz == ".js" || hz == ".ts"){
...
export function f_basename(str:string,hz:string):string{
    if(hz == ".js" || hz == ".ts"){
        if(str.endsWith(".js")){
...
export function f_existsSync(str:string){
...
let loadBaseConfig = function (app: Application) {
    loadConfigBaseApp(app, "masterConfig", path.join(some_config.File_Dir.Config, 'master'));
    loadConfigBaseApp(app, "serversConfig", path.join(some_config.File_Dir.Config, 'servers'));
    loadConfigBaseApp(app, "routeConfig", path.join(some_config.File_Dir.Config, 'protoCfg'));
