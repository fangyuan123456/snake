...
export function getExName(str:string){
    return "."+str.split(".")[1]
}
...
let loadBaseConfig = function (app: Application) {
    loadConfigBaseApp(app, "masterConfig", path.join(some_config.File_Dir.Config, 'master'+app.srcType));
    loadConfigBaseApp(app, "serversConfig", path.join(some_config.File_Dir.Config, 'servers'+app.srcType));
    loadConfigBaseApp(app, "routeConfig", path.join(some_config.File_Dir.Config, 'protoCfg'+app.srcType));
