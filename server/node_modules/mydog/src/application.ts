...
export default class Application extends EventEmitter {
    ...
    kickUserFunc:(uid:number)=>void = function () { };
    ...
    callKickUserFunc(uid:number){
        if(this.kickUserFunc){
            this.kickUserFunc(uid);
        }
    }
    setKickUserFunc(callBack:()=>void){
        this.kickUserFunc = callBack;
    }
