...
class ClientManager {
     ...
     */
    loadHandler() {
        let dirName = path.join(this.app.base, define.some_config.File_Dir.Servers, this.serverType, "net/handler");
            ...
            this.app.filter.globalBeforeFilter(data, client.session, (hasError) => {
                ...
                if (this.serverType === cmdArr[0]) {
                    ...
                    this.app.filter.beforeFilter(data.cmd, msg, client.session, (hasError) => {
                        ...
                        if (this.msgHandler[cmdArr[1]][cmdArr[2]]) {
                            this.msgHandler[cmdArr[1]][cmdArr[2]](data, client.session, this.callBack(client, data.cmd));
                        }
                        else {
                            this.msgHandler[cmdArr[1]]["route"](cmdArr[2], data, client.session, this.callBack(client, data.cmd));
                        }
                    });
                }
                else {
