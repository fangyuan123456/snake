...
const appUtil_1 = require("mydog/src/util/appUtil");
...
class ClientManager {
    ...
    loadHandler() {
        ...
        let exists = (0, appUtil_1.f_existsSync)(dirName);
        if (exists) {
            let self = this;
            fs.readdirSync(dirName).forEach(function (filename) {
                if (!(0, appUtil_1.f_endsWith)(filename, ".js")) {
                    return;
                }
                let name = (0, appUtil_1.f_basename)(filename, '.js');
