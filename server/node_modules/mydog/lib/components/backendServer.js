...
class BackendServer {
     ...
     */
    loadHandler() {
        let dirName = path.join(this.app.base, define.some_config.File_Dir.Servers, this.app.serverType, "net/handler");
    ...
    handleMsg(id, msg) {
        ...
        this.app.filter.beforeFilter(cmd, data, session, (hasError) => {
            ...
            if (this.msgHandler[cmdArr[1]][cmdArr[2]]) {
                ...
                this.msgHandler[cmdArr[1]]["route"](cmdArr[2], data, session, this.callback(id, cmd, session));
            }
        });
    }
