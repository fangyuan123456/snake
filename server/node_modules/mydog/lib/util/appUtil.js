...
exports.getExName = exports.getNoRpcKey = exports.startServer = exports.defaultConfiguration = void 0;
...
let loadBaseConfig = function (app) {
    loadConfigBaseApp(app, "masterConfig", path.join(define_1.some_config.File_Dir.Config, 'master' + app.srcType));
    loadConfigBaseApp(app, "serversConfig", path.join(define_1.some_config.File_Dir.Config, 'servers' + app.srcType));
    loadConfigBaseApp(app, "routeConfig", path.join(define_1.some_config.File_Dir.Config, 'protoCfg' + app.srcType));
