...
exports.decodegetVipReq = exports.encodegetVipReq = void 0;
function encodegetVipReq(message) {
    let bb = popByteBuffer();
    _encodegetVipReq(message, bb);
    return toUint8Array(bb);
}
exports.encodegetVipReq = encodegetVipReq;
...
function decodegetVipReq(binary) {
    return _decodegetVipReq(wrapByteBuffer(binary));
}
exports.decodegetVipReq = decodegetVipReq;
